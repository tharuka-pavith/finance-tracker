            ...
            <Paper elevation={10} sx={paperStyles}>
                ...
                <Box sx={gridStyle}>
                    ...
                    <Stack sx={{mt: '20px'}} direction='row' spacing={2} alignItems="center" justifyContent="center">
                        <Box><Button size='medium' sx={buttonStyle} variant="contained" color='success'>Signup</Button></Box>
                        <Box><Button href='/home' size='medium' sx={buttonStyle} variant="outlined" color='error'>Cancel</Button></Box>
                    </Stack>
